...
const AddAdmin = () => {
  ...
  const fetchdata = ()=>{
    AxiosInstance.get('/admin_dashboard/getAdmin.php').then((res)=>{
      setadmindata(res?.data?.admin_data);
    })
  }
  ...
  const handledelete = (id) => {
    AxiosInstance.delete(`/admin_dashboard/deleteadmin.php?id=${id}`).then((res)=>{
  ...
  const handlesubmit = (e) => {
    ...
    {editmode ?
    AxiosInstance.put(
      "/admin_dashboard/updateadmin.php",
