...
const Student_registration = () => {
  ...
  const fetchdata = ()=>{
    AxiosInstance.get('/admin_dashboard/getStudent.php').then((res)=>{
      setstuddata(res?.data?.student_data);
    })
  }
  ...
  const handledelete = (id) => {
    AxiosInstance.delete(`/admin_dashboard/deletestudent.php?id=${id}`).then((res)=>{
  ...
  const handlesubmit = (e) => {
    ...
    {editmode ?
    AxiosInstance.put(
      "/admin_dashboard/updatestudent.php",
